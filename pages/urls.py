...
# We want a url for our homepage
from . import views # the 'from .' is saying 'from all'
...
# This will create an error as we haven't created a method called index in the views file